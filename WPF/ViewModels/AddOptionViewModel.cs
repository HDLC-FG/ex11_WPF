...
namespace WPF.ViewModels
{
    ...
    {
        private readonly Windows.AddOption window;
        ...
        public AddOptionViewModel(VehicleViewModel selectedVehicle, IOptionService optionService, Windows.AddOption window)
        {
